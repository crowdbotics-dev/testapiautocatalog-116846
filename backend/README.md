...
## Project Structure
    ...
    ├── testapiautocatalog_116846  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_116846`
...
2. Clone this repo and `cd testapiautocatalog_116846`
